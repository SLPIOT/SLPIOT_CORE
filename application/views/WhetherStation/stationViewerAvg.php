                    ...
                    <div class="container">
                        <div class="row">
                            <div class="card-box col-lg-4">
                                    <select class="form-control " id="avgTime">
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30" id="ttl">Station Details per 24 Hours</h4>
                                    <!-- end of header-->
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Rain Gauge(mm per <?php echo $_GET['rate'];?> hours)</th>
                                                <th>Pressure(pa)</th>
                                                <th>Soil Moisture %</th>
                                                <th>Water Level</th>
                                                <th>Battery (V)</th>
        ...
        <script src="../assets/pages/datatables.init.js"></script>
         ...
         <script type="text/javascript">
            $(document).ready(function() {
                ...
                var v = $.urlParam('rate');
                $('#ttl').text('Station Details '+v+' Hours');
                $('#avgTime').val(v+' Hours');
                $('#cmdSearch').click(function(){
                    var c = $('#dtsearch').val();
                    var v = $.urlParam('Code');
                    var f = parseInt($('#avgTime').val().substring(0,2));
                    window.location.href='loadAvgWhetherDetails?Code='+v+'&date='+c+'&rate='+f;
                });
            } );
